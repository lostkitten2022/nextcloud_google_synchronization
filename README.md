...
**This is a fork of the [https://github.com/MarcelRobitaille/nextcloud_google_synchronization] app. Do not use both at the same time!!**
...
仅添加Google 通讯录同步功能，其他使用说明和注意事项请参照原链接。
